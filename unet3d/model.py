...
from unet3d.SEUNet3D import SEResUNet3D
...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, f_maps=64, layer_order='crg', num_groups=8,is_test = False,
                 **kwargs):
...
class ResidualUNet3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, f_maps=32, conv_layer_order='cge', num_groups=8, is_test = False,
                 **kwargs):
