...
fpath_h5 = 'checkpoints/3dunet_pwtvfl1_3dseres_c1b2_fd/h5_pred/p_43_predictions.h5'#'resources/ct01m_c1_predictions.h5' # input h5 file path
fpath_h5 = 'checkpoints/3dunet_pwtvfl1_3dseres_c1b2_fd_rs_upad/h5_pred/p_34_predictions.h5'#'resources/ct01m_c1_predictions.h5' # input h5 file path


fpath_ply = 'pc1.ply' # output ply file path
th_conf = 0.5; # confidence threshold
id_class = 0; # class id


with h5py.File(fpath_h5, 'r') as f:
    conf_map_buf = f['predictions'][...]
